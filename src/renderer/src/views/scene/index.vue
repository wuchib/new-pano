<template>
  <div class="w-full h-full flex flex-col gap-[12px] overflow-hidden">
    ...
    <div class="w-full flex justify-between items-center">
      ...
      <div class="flex gap-[8px]">
        <div class="flex justify-center items-center overflow-hidden">
          <div
            :class="[getRounded(i), curView === view.value ? 'border-[#99e4c6]' : 'border-[#5e5e5e]', curView === view.value?'text-[#99e4c6]':'text-[#fff]/85']"
    ...
    <div class="w-full flex-1 overflow-hidden">
        <!-- 卡片视图 -->
        <div class="w-full h-full overflow-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4" v-if="curView==='img'">
            <div v-for="value in 60" class="flex flex-col h-[230px] border-[#414141] border-solid border-[1px] rounded-[6px] overflow-hidden group">
                <div class="flex-1 overflow-hidden position-relative">
                    <img src="../../assets/cover.png" alt="" class="w-full h-full">
                    <div class="position-absolute z-1 top-0 left-0  h-full w-full flex opacity-0 group-hover:opacity-100 bg-[#000]/45 transition-all duration-300">
                        <div class="flex justify-center items-center flex-1 h-full border-0 border-r-[2px] border-solid border-[#414141]">
                ...
                <div class="flex flex-col justify-center gap-[4px] h-[70px] border-0 border-t-[1px] border-solid border-[#414141] px-[12px] text-[#fff]/65">
